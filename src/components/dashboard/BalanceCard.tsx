...
export function BalanceCard() {
  ...
  return (
    <Card className="overflow-hidden glass-card shadow-lg border-none relative bg-gradient-to-br from-primary/90 to-primary/70 dark:from-primary/50 dark:to-primary/30 text-white">
